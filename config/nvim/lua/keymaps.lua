...
end, opts('Find Keymap'))
keymap('n', '<Leader>fr', function()
	require('telescope.builtin').registers()
end, opts('Find Register'))
keymap('n', '<Leader>fs', function()
	require('telescope.builtin').spell_suggest()
end, opts('Find Spelling'))
keymap('n', '<Leader>fc', function()
	require('telescope.builtin').colorscheme()
end, opts('Find colorscheme'))
keymap('n', '<Leader>fm', function()
	require('telescope.builtin').marks()
end, opts('Find Mark'))
keymap('n', '<Leader>fh', function()
	require('telescope.builtin').help_tags()
end, opts('Find Help Tags'))
keymap('n', '<Leader>fp', function()
	require('telescope').extensions.project.project()
end, opts('Find Project'))
keymap('n', '<Leader>fw', function()
	require('telescope').extensions.git_worktree.git_worktrees()
end, opts('Find Worktree'))
keymap('n', '<leader>fia', function()
	require('telescope').extensions.symbols.symbols()
end, opts('Find All Icons'))
keymap('n', '<leader>fin', function()
	require('telescope').extensions.symbols.symbols({ sources = { 'nerd' } })
end, opts('Find Nerdfonts Icons'))
keymap('n', '<leader>fie', function()
	require('telescope').extensions.symbols.symbols({ sources = { 'emoji' } })
end, opts('Find Emoji Icons'))
keymap('n', '<leader>fik', function()
	require('telescope').extensions.symbols.symbols({ sources = { 'kaomoji' } })
...
keymap('n', '<leader>fil', function()
	require('telescope').extensions.symbols.symbols({ sources = { 'latex' } })
end, opts('Find LaTeX Icons'))
keymap('n', '<leader>fig', function()
	require('telescope').extensions.symbols.symbols({ sources = { 'gitmoji' } })

...
myBrowser :: String
myBrowser = "google-chrome-stabe "  -- Sets google chrome as browser

myEmacs :: String
myEmacs = "emacsclient -c -a 'emacs' "  -- Makes emacs keybindings easier to type

myEditor :: String
myEditor = "nvim "  -- Sets neovim as editor
...
myStartupHook = do
  ...
  -- spawnOnce "xargs xwallpaper --stretch < ~/Wallpapers/demon-slayer/demon_slayer2.jpg"
  -- spawnOnce "~/.fehbg &"  -- set last saved feh wallpaper
  spawnOnce "feh --randomize --no-fehbg --bg-fill ~/Wallpapers/**/**"  -- feh set random wallpaper
...
myKeys c =
	...
	subKeys "Xmonad Essentials" [
		...
		("M-ctrl-q", addName "Kill all windows on WS" $ killAll),
	...
	^++^ subKeys "Favorite programs" [
		...
		("M-C-w", addName "Launch web browser" $ spawn (myBrowser)),
		("M-M1-e", addName "Launch file manager (ranger/lf)" $ spawn (myTerminal ++ " -e ranger"))
	]
